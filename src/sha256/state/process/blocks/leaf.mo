...
module {
  ...
  /// Inner block of a leaf combine: hash one 64-byte block whose words 0..7 are
  /// blob `b1` and words 8..15 are blob `b2` (each 32 bytes), starting the
  /// compression from the SHA256 IV, and overwrite `self` with the result.
  /// Produces the first compression of SHA256(b1 ++ b2); the caller adds the
  /// padding block. No message buffer, no allocation.
  public func process(self : [var Nat16], b1 : Blob, b2 : Blob) : () {
    // message words 0..7 from b1, 8..15 from b2
    let w00 = nat16To32(nat8To16(b1[0])) << 24 | nat16To32(nat8To16(b1[1])) << 16 | nat16To32(nat8To16(b1[2])) << 8 | nat16To32(nat8To16(b1[3]));
    let w01 = nat16To32(nat8To16(b1[4])) << 24 | nat16To32(nat8To16(b1[5])) << 16 | nat16To32(nat8To16(b1[6])) << 8 | nat16To32(nat8To16(b1[7]));
    let w02 = nat16To32(nat8To16(b1[8])) << 24 | nat16To32(nat8To16(b1[9])) << 16 | nat16To32(nat8To16(b1[10])) << 8 | nat16To32(nat8To16(b1[11]));
    let w03 = nat16To32(nat8To16(b1[12])) << 24 | nat16To32(nat8To16(b1[13])) << 16 | nat16To32(nat8To16(b1[14])) << 8 | nat16To32(nat8To16(b1[15]));
    let w04 = nat16To32(nat8To16(b1[16])) << 24 | nat16To32(nat8To16(b1[17])) << 16 | nat16To32(nat8To16(b1[18])) << 8 | nat16To32(nat8To16(b1[19]));
    let w05 = nat16To32(nat8To16(b1[20])) << 24 | nat16To32(nat8To16(b1[21])) << 16 | nat16To32(nat8To16(b1[22])) << 8 | nat16To32(nat8To16(b1[23]));
    let w06 = nat16To32(nat8To16(b1[24])) << 24 | nat16To32(nat8To16(b1[25])) << 16 | nat16To32(nat8To16(b1[26])) << 8 | nat16To32(nat8To16(b1[27]));
    let w07 = nat16To32(nat8To16(b1[28])) << 24 | nat16To32(nat8To16(b1[29])) << 16 | nat16To32(nat8To16(b1[30])) << 8 | nat16To32(nat8To16(b1[31]));
    let w08 = nat16To32(nat8To16(b2[0])) << 24 | nat16To32(nat8To16(b2[1])) << 16 | nat16To32(nat8To16(b2[2])) << 8 | nat16To32(nat8To16(b2[3]));
    let w09 = nat16To32(nat8To16(b2[4])) << 24 | nat16To32(nat8To16(b2[5])) << 16 | nat16To32(nat8To16(b2[6])) << 8 | nat16To32(nat8To16(b2[7]));
    let w10 = nat16To32(nat8To16(b2[8])) << 24 | nat16To32(nat8To16(b2[9])) << 16 | nat16To32(nat8To16(b2[10])) << 8 | nat16To32(nat8To16(b2[11]));
    let w11 = nat16To32(nat8To16(b2[12])) << 24 | nat16To32(nat8To16(b2[13])) << 16 | nat16To32(nat8To16(b2[14])) << 8 | nat16To32(nat8To16(b2[15]));
    let w12 = nat16To32(nat8To16(b2[16])) << 24 | nat16To32(nat8To16(b2[17])) << 16 | nat16To32(nat8To16(b2[18])) << 8 | nat16To32(nat8To16(b2[19]));
    let w13 = nat16To32(nat8To16(b2[20])) << 24 | nat16To32(nat8To16(b2[21])) << 16 | nat16To32(nat8To16(b2[22])) << 8 | nat16To32(nat8To16(b2[23]));
    let w14 = nat16To32(nat8To16(b2[24])) << 24 | nat16To32(nat8To16(b2[25])) << 16 | nat16To32(nat8To16(b2[26])) << 8 | nat16To32(nat8To16(b2[27]));
    let w15 = nat16To32(nat8To16(b2[28])) << 24 | nat16To32(nat8To16(b2[29])) << 16 | nat16To32(nat8To16(b2[30])) << 8 | nat16To32(nat8To16(b2[31]));

    // compression registers start at the SHA256 IV
    var a = 0x6a09e667 : Nat32;
    var b = 0xbb67ae85 : Nat32;
    var c = 0x3c6ef372 : Nat32;
    var d = 0xa54ff53a : Nat32;
    var e = 0x510e527f : Nat32;
    var f = 0x9b05688c : Nat32;
    var g = 0x1f83d9ab : Nat32;
    var h = 0x5be0cd19 : Nat32;
    var t = 0 : Nat32;
