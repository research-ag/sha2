...
module {
  ...
  /// two 32-byte digest states (`sa` -> message words 0..7, `sb` -> words
  /// 8..15), updating the 16 half-word state `self` in place. The caller must be
  /// at a block boundary (empty buffer); no message buffer, no closures, no
  /// allocation.
  public func process(self : [var Nat16], sa : [var Nat16], sb : [var Nat16]) : () {
    ...
    let w00 = nat16To32(sa[0]) << 16 | nat16To32(sa[1]);
    let w01 = nat16To32(sa[2]) << 16 | nat16To32(sa[3]);
    let w02 = nat16To32(sa[4]) << 16 | nat16To32(sa[5]);
    let w03 = nat16To32(sa[6]) << 16 | nat16To32(sa[7]);
    let w04 = nat16To32(sa[8]) << 16 | nat16To32(sa[9]);
    let w05 = nat16To32(sa[10]) << 16 | nat16To32(sa[11]);
    let w06 = nat16To32(sa[12]) << 16 | nat16To32(sa[13]);
    let w07 = nat16To32(sa[14]) << 16 | nat16To32(sa[15]);
