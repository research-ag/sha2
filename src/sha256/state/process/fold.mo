...
module {
  ...
  public func process(self : [var Nat16]) : () {
    ...
    let w16 = w00 +% rot(w01, 07) ^ rot(w01, 18) ^ (w01 >> 03);
    let w17 = w01 +% rot(w02, 07) ^ rot(w02, 18) ^ (w02 >> 03) +% rot(w15, 17) ^ rot(w15, 19) ^ (w15 >> 10);
    let w18 = w02 +% rot(w03, 07) ^ rot(w03, 18) ^ (w03 >> 03) +% rot(w16, 17) ^ rot(w16, 19) ^ (w16 >> 10);
    let w19 = w03 +% rot(w04, 07) ^ rot(w04, 18) ^ (w04 >> 03) +% rot(w17, 17) ^ rot(w17, 19) ^ (w17 >> 10);
    let w20 = w04 +% rot(w05, 07) ^ rot(w05, 18) ^ (w05 >> 03) +% rot(w18, 17) ^ rot(w18, 19) ^ (w18 >> 10);
    let w21 = w05 +% rot(w06, 07) ^ rot(w06, 18) ^ (w06 >> 03) +% rot(w19, 17) ^ rot(w19, 19) ^ (w19 >> 10);
    ...
    let w24 = w08 +% w17 +% rot(w22, 17) ^ rot(w22, 19) ^ (w22 >> 10);
