...
// then hashing the resulting digest. Check both algorithms across message
// lengths that exercise every padding path (empty, sub-block, block-boundary,
// the 55/56-byte length-field edge, and multi-block).
